 ...
 $("#submit").click(function (e) {
    ...
    $.ajax({
        ...
        $(".search_results").append('<p class="fv">' + "# of links (per 1000 words): " + returned_dictionary[0].sample_feature_vector[5] + '</p>');
        $(".search_results").append('<p class="fv">' + "# of misspellings (per 1000 words): " + returned_dictionary[0].sample_feature_vector[6] + '</p>');
        ...
        $(".search_results").append('<p class="fv">' + "# of misspellings (per 1000 words): " + returned_dictionary[0].post_feature_vector[6] + '</p>');
